...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--config",
        type=str,
        default="config/crs/tgredial/tgredial.yaml",
    ...
    parser.add_argument(
        "-sd", "--save_data", action="store_true", help="save processed dataset"
    )
    parser.add_argument(
        "-rd", "--restore_data", action="store_true", help="restore processed dataset"
    )
    parser.add_argument(
        "-ss", "--save_system", action="store_true", help="save trained system"
    )
    parser.add_argument(
        "-rs", "--restore_system", action="store_true", help="restore trained system"
    )
    parser.add_argument(
        "-d",
        "--debug",
