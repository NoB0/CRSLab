...
class DuRecDialDataset(BaseDataset):
    ...
    def _load_other_data(self):
        ...
        self.entity_kg = open(
            os.path.join(self.dpath, "entity_subkg.txt"), encoding="utf-8"
        )
        logger.debug(
        ...
        self.word_kg = open(
            os.path.join(self.dpath, "hownet_subkg.txt"), encoding="utf-8"
        )
        logger.debug(
    ...
    def _side_data_process(self):
        ...
        with open(
            os.path.join(self.dpath, "item_ids.json"), "r", encoding="utf-8"
        ) as f:
